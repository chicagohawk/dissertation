...
\begin{frame}
    \frametitle{Review of multi-fidelity optimization (MFO)\hfill \scriptsize{optimization}}
    \vspace{-.4cm}
    \begin{center}
...
\begin{frame}
    ...
    \begin{dinglist}{228}
        ...
        \small
        \vspace{.2cm}
        \barrow Relates gray-box model's objective with twin model's gradient:
    ...
    \begin{dinglist}{228}
        ...
        \barrow Candidate simulation models: \vspace{.1cm}
                \begin{dinglist}{227}
                    ...
                    LES, DNS, etc
                \end{dinglist}
        \barrow Apply twin model optimization framework:
                \begin{dinglist}{227}
                    \carrow \textcolor{darkred}{Gray-box model}: time averaged quantities of LES simulation.
...
\begin{frame}
    \frametitle{Candidate models for turbulent flow \hfill \scriptsize{application}}
\end{frame}

\begin{frame}
    \frametitle{Review of RANS models \hfill \scriptsize{application}}
\end{frame}

\begin{frame}
    \frametitle{Optimization by twin model \hfill \scriptsize{application}}
\end{frame}

\begin{frame}
    \frametitle{Infer PDEs for eddy viscosity \hfill \scriptsize{application}}
\end{frame}

\begin{frame}
    \frametitle{Future work for turbulent flow optimization \hfill \scriptsize{application}}
\end{frame}
...
\begin{frame}
    \frametitle{Expected contributions \hfill}
    \begin{dinglist}{228}
        ...
        \barrow Provide an optimization framework based on gray-box conservation law
                simulation in high-dimensional design problems.
...
\begin{frame}
    \frametitle{Proposed schedule \hfill}
    \cite{Autor, 90}
\end{frame}
...
\begin{frame}
    \frametitle{Discussion of optimization convergence\hfill \scriptsize{optimization}}
\end{frame}

\begin{frame}
    \frametitle{Exploit twin model more than its gradient?\hfill \scriptsize{optimization}}
\end{frame}

\begin{frame}
    \frametitle{Extension to constraint optimization \hfill \scriptsize{optimization}}
\end{frame}
