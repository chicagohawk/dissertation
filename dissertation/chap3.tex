...
%The gray-box solution generated at different values of control variables are correlated.
%a twin model can be trained ..............
%The evaluations of gray-box objective function at 
...
%\footnote{
%$\tilde{\xi}(c)$ is the objective evaluation provided by a twin model which is
...
control variable.\\
%\eqref{eqn: gradient model inadequacy} has
...
%as discussed in Section \ref{section: GBO}. 
...
%We refer to Section \ref{section: bayes opt} for the details.
...
\begin{algorithm}[htbp]
\begin{algorithmic}[1]
\REQUIRE{$\mathcal{A}, \alpha_{\mathcal{A}}$ of the trained twin model at the last iteration.}
\STATE Compute $\overline{\mathcal{M}}$ by $k$-fold cross validation. 
       $\overline{\mathcal{M}}_0\leftarrow 
       \overline{\mathcal{M}}$.
\WHILE{$\left|\mathcal{A}\right|>1$}
...
\section{Convergence Properties Using True Hyper Parameters}
...
The assumptions in Section \ref{sec: chap3 cokriging} are revisited as follows:
$\xi$ 
...
Represent the stochastic dependence of $\xi$ by $\omega_\xi$, and represent 
...
\end{equation}
The search strategy $\underline{C}$ generates a search sequence $C_1, C_2, \cdots$ 
in $\mathcal{C}$,
...
\begin{figure}[htbp]\begin{center}
    \includegraphics[width=8.2cm,height=6.3cm]{../opt_BL_marker.png}
    %~/Documents/2014GRAD/mirror/final_2/results
...
Let $S(c)$ be the area of the return bend. 
$S(c)$ is a function of the 
control points' coordinates represented by $c$. Let $S_0 = \frac{1}{2}\pi(1.25^2-0.25^2)$.
...
Figures \ref{fig: NS opt geo combined} (a) and (c) show
the initial and the optimized geometries for
the van der Waals and the Redlich-Kwong gases.
Figures \ref{fig: NS opt geo combined} (b) and (d) 
show the corresponding pressure profiles at the interior and the exterior boundaries along
...
Figure \ref{fig: RK iteration} shows the geometry,
the trained state equation, and the basis dictionary for the first five iterations
and the optimized result of the Bayesian optimization. In this numerical example,
the trained state equation and the basis dictionary are similar at each Bayesian optimization
iteration.
Figure \ref{fig: NS opt obj 2} shows the current best objective evaluation at each iteration.
The twin-model estimated gradient enables faster improvement of the objective evaluation.
%After a small number of iterations, twin-model Bayesian optimization achieves near optimality.
Figure \ref{fig: NS opt wall clock} shows the wall clock time of the optimization
against the number of iterations. Although twin model increases the computational
cost per iteration, the increased cost is offset by faster improvement of the objective function. \\
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{.35\textwidth}
        \centering
        \includegraphics[height=6cm]{../Ubend_combined_new_a.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[t]{.64\textwidth}
        \centering
        \includegraphics[height=6cm]{../Ubend_combined_new_b.png}
        \caption{}
    \end{subfigure}\\
    \begin{subfigure}[t]{.35\textwidth}
        \centering
        \includegraphics[height=6cm]{../Ubend_combined_new_a_RK.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[t]{.64\textwidth}
        \centering
        \includegraphics[height=6cm]{../Ubend_combined_new_b_RK.png}
        \caption{}
    \end{subfigure}
    \caption{(a) shows the initial guess of control points (blue dots), 
             ...
             geometry (red line) for the van der Waals gas. The blue squares indicate the bound 
             constraints for each control point. (b) shows the 
             pressure along the interior and the exterior boundaries for
             the initial (blue) and the optimized (red) geometry. (c) and
             (d) show the results for the Redlich-Kwong gas.}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_fit_0_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_err_0_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/geo_0.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/basis_0_RK.png}
        \caption{Iteration 0}
        \label{fig: RK iteration 0}
    \end{subfigure}
\end{center}\end{figure}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}     
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case1/state_fit_1_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case1/state_err_1_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case1/geo_1.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case1/basis_1_RK.png}
        \caption{Iteration 1}
        \label{fig: RK iteration 1}
    \end{subfigure}
\end{center}
\end{figure}
\begin{figure}\ContinuedFloat
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case2/state_fit_2_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case2/state_err_2_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case2/geo_2.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case2/basis_2_RK.png}
        \caption{Iteration 2}
        \label{fig: RK iteration 2}
    \end{subfigure}
\end{center}
\end{figure}
\begin{figure}\ContinuedFloat
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case3/state_fit_3_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case3/state_err_3_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case3/geo_3.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case3/basis_3_RK.png}
        \caption{Iteration 3}
        \label{fig: RK iteration 3}
    \end{subfigure}
\end{center}
\end{figure}
\begin{figure}\ContinuedFloat
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}     
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case4/state_fit_4_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case4/state_err_4_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case4/geo_4.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case4/basis_4_RK.png}
        \caption{Iteration 4}
        \label{fig: RK iteration 4}
    \end{subfigure}
\end{center}
\end{figure}
\begin{figure}\ContinuedFloat
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case99/state_fit_99_RK.png} \hspace{.5cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case99/state_err_99_RK.png}\\
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case99/geo_99.png} \hspace{2cm}
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case99/basis_99_RK.png}
        \caption{Optimized}
        \label{fig: RK iteration 99}
    \end{subfigure}
\end{center}
\caption{The trained state equation, the error of the trained state equation,
         the return bend geometry, and the basis dictionary at some iterations
         of the Bayesian optimization.
         The gray-box model uses the Redlich-Kwong state equation. 
         The resolution of the bases is represented using the same symbols as in 
         Figure \ref{fig: selected basis NS}.}
\label{fig: RK iteration}
\end{figure}
...
\begin{figure}[htbp]\begin{center}
    ...
    \caption{The current best objective at each iteration for the van der Waals gas and the 
             Redlich-Kwong gas. The green lines are
             obtained by the twin-model Bayesian optimization. The red lines are
             obtained by the Bayesian optimization without the estimated gradient. 
             The black horizontal lines
             indicate the true optimal, obtained by BFGS using the true gradient.}
    \label{fig: NS opt obj 2}
\end{center}\end{figure}

\begin{figure}[htbp]\begin{center}
    \includegraphics[width=9cm]{../NS_compute_time_2.png}
    \caption{The cumulative and per-iteration wall clock time, in minutes. Although
             the twin-model Bayesian optimization is more costly per-iteration due 
             to the training of twin model, it achieves near-optimality with
             less overall computational time. The gray-box model uses the Redlich-Kwong state
             equation.}
...
\subsubsection{Time-independent control}
Firstly, consider constant-in-time injection rates at the injectors. Let the price
of unit mass oil be $e^{-\frac{t}{\tau}}$ which decays over time, where $\tau>0$ is 
a constant. Let the price of unit mass water 
be $0<\lambda<1$. Define 
%\tau=30
\begin{equation}
    \xi(t) = \left(\int_0^t \rho_{\textrm{prod}\, o} S_o e^{-\frac{t}{\tau}} I_{\textrm{prod}}\textrm{d}t 
           - \int_\Omega \rho_o(t=0) \phi S_o(t=0) \textrm{d}x \right)
           - \lambda t \sum_{i=1}^5 \rho_{\textrm{inj}wi} I_{\texttt{inj}i}\,,
...
%    \label{eqn: chap 3 reservoir cum cost}
%\end{equation}
which represents the price of the produced oil produced 
minus the price of all residual oil at $t=0$ and the price of the total water injected.
$\rho_{\textrm{prod}o}$ is the oil phase density at the producer, 
$\rho_{\textrm{inj}wi}$'s are the water phase densities at the injectors,
$I_{\textrm{prod}}$ is the production rate at the producer, and
$I_{\texttt{inj}i}$'s are the injection rates at the $i$th injector. 
...
is obtained by COBYLA \cite{linear trust region} after running $192$ gray-box simulations.}.
The twin model Bayesian optimization achieves
near-optimality faster than the vanilla Bayesian optimization without using 
...
\begin{figure}[htbp]\begin{center}
    ...
    \caption{The current best objective evaluation against the number of iterates. 
             The black line indicates the true optimal obtained by COBYLA optimization
             \cite{linear trust region},
...
\subsubsection{Time-dependent control}
...
The problem of scaling is generally suffered by non-parametric methods.}. Instead,
