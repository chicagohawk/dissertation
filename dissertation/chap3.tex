...
Based upon the
developments in Section \ref{sec: chap3 cokriging}, I present the flowchart, 
Figure \ref{fig: opt flowchart}, of the Bayesian optimization algorithm.
The detailed algorithm is given in
Algorithm \ref{alg: bayes opt twin}. \\
