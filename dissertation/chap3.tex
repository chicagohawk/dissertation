...
where $\xi$ is the objective function, $\boldsymbol{u}$ is the gray-box solution, $c$ is the 
...
Let $\nabla\xi$ be the true gradient by using the gray-box model,
$\xi_{\tilde{\nabla}}$ be the twin-model estimated gradient \footnote{
