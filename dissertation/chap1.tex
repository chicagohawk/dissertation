...
Explain that (dF/du)^T in this case can be derived as another differenitial operator, with a different set of boundary conditions and/or initial conditions, that uniquely determines a lambda. Refer to papers / books that contain readable derivation of the continuosu adjoint.

The discrete adjoint method 
discretizes $\mathcal{F}(u,c)=0$ first, then linearizes the discretized adjoint equation \cite{discrete adjoint}.
