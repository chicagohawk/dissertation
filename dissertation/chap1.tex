...
\footnote{
    The square integrable functions form an inner product space with inner product given by
...
I didn't know that all square integrable functions can be represented exactly using a infinite series of the same basis. What kind of basis is sufficient? Is that a famous theorem? Citation please
