...
In addition, the trained twin model is simulated using out-of-sample initial conditions. Two example gray-box
...
at $c=0$ with the solution shown in Figure \ref{fig: insample test}. 
