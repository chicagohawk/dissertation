...
\begin{theorem}
    ...
    %which approximates \eqref{eqn: cont sol mismatch}
    %\begin{equation*}
    %    \int_{0}^T\int_\Omega \big(\tilde{u}(t,x) - u(t,x)\big)^2 \, \textrm{d}x\,\textrm{d}t\,.
    %\end{equation*}
    ...
    \end{equation}
    %which approximates \eqref{eqn: integrated residual}
    %\begin{equation*}
    %    \int_0^T \int_\Omega \tau^2 \, \textrm{d}x\textrm{d}t\,.
    %\end{equation*}
...
%The proof is given in Appendix \ref{proof 2}. 
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=7.3cm]{../basis_0_flip.png}
        \caption{$\left(0,0\right)$}
        \label{fig: basis 0}
    \end{subfigure} \hspace{.0cm}
    \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=7.3cm]{../basis_1_flip.png}
        \caption{$\left(0, -1\right)$}
        \label{fig: basis 1}
    \end{subfigure}
    \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=7.3cm]{../basis_3_flip.png}
        \caption{$\left(1, 0\right)$}
        \label{fig: basis 2}
    \end{subfigure} \hspace{.0cm}
    \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[width=7.3cm]{../basis_6_flip.png}
...
and $2k$ bases whose translation parameters are shifted by $\pm 1$.
...
\begin{figure}[Htbp]\begin{center}
    \begin{subfigure}[p]{1.\textwidth}
        \centering
        \includegraphics[width=10cm]{../basis_neighbor_flip.png}
        \caption{$\mathcal{N}\left[\left(0,0\right)\right]$}
        \label{fig: basis neighbor}
    \end{subfigure}
    \begin{subfigure}[p]{1.\textwidth}
        \centering
        \includegraphics[width=10cm]{../basis_neighbor_2_flip.png}
...
Another criterion is needed to determine whether a basis shall indeed be added or removed.
...
%the number of bases in the dictionary decreases but
...
%, where initial condition of the training solution 
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_2.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_5.png}
        \caption{Iteration 1}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}     
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_3.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_6.png}
        \caption{Iteration 2}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_4.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_7.png}
        \caption{Iteration 3}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_9.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_8.png}
        \caption{Iteration 4}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}     
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_10.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_11.png}
        \caption{Iteration 5}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_12.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_200.png}
        \caption{Iteration 6}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}     
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_14.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_13.png}
        \caption{Iteration 7}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_16.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_13.png}
        \caption{Iteration 8}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_18.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_19.png}
        \caption{Iteration 9}
...
\begin{center}
    \begin{subfigure}[t]{1.\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_20.png}
        \includegraphics[height=4.5cm]{/home/voila/Documents/2014GRAD/mirror/final_3/basisHistory/figure_21.png}
...
In both the gray-box and the twin models, we use the same 
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{.49\textwidth}
        \centering
        \includegraphics[height=5.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/basis_0_VDW.png}
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{.99\textwidth}
        ...
        \includegraphics[height=4.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_fit_0_VDW.png}
        \includegraphics[height=4.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_err_0_VDW.png}
    ...
    \begin{subfigure}[t]{.99\textwidth}
        ...
        \includegraphics[height=4.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_fit_0_RK.png}
        \includegraphics[height=4.cm]{/home/voila/Documents/2014GRAD/numpad/test/ns_cases_opt/thesis_add/iteration/case0/state_err_0_RK.png}
...
%In this case, the governing equation \eqref{eqn: two phase polymer} not only depends on
%the derivatives of the mobility factors, but also depends on the value of the mobility factors.
%We will still use the sigmoid parameterization.
\\

\emph{PSim}, the industrial simulator aforementioned in Section \ref{sec: motivation}, is
...
\begin{figure}[htbp]\begin{center}
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/mrst-2015b/mobO.png}
        \caption{Oil mobility.}
        \label{fig: mob O}
    \end{subfigure}\\
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/mrst-2015b/mobP.png}
        \caption{Polymer mobility.}
        \label{fig: mob P}
    \end{subfigure}\\
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \includegraphics[height=4.5cm]{/home/voila/Documents/mrst-2015b/mobW.png}
...
\begin{tabular}{ccc}
    ...
    (-2,  -1,  -1,     0,     2,     3) \\
\end{tabular}
\captionof{table}{($j_p, j_{sW}, j_c, \eta_p, \eta_{sW}, \eta_c$) for $M_o$.}
\label{tab: mob O}
\end{center}
...
(-2,  0,  0,    -1,   0,     2) &
\end{tabular}
\captionof{table}{($j_p, j_{sW}, j_c, \eta_p, \eta_{sW}, \eta_c$) for $M_{wp}$.}
\label{tab: mob P}
\end{center}
...
(-2,  -1,  -1,     0,     2,     3)&
\end{tabular}
\captionof{table}{($j_p, j_{sW}, j_c, \eta_p, \eta_{sW}, \eta_c$) for $M_w$.}
\label{tab: mob W}
\end{center}

\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=8cm]{/home/voila/Documents/2014GRAD/proposal_defense/M_history_reservoir.png}
