...
\begin{equation}
    \tilde{F} = \sum_{{j}\in A\subset \mathbb{Z}^k, {\eta}\in B\subset
                       \mathbb{Z}^k} 
                       \alpha_{{j}, {\eta}}
                       \phi_{{j}, {\eta}}\,,
...
in the parameterization, represented by the set $A$ and $B$ in \eqref{eqn: linear expansion finite},
...
Figure \ref{fig: sigmoid basis ad hoc} shows an example of the chosen bases.
