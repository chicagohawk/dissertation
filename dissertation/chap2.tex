...
allows the separation of the basis selection and the twin model simulation,
therefore is computationally preferrable.\\

In the following, a sufficient condition under which the bound exists is provided
