...
\ref{sec: adaptive basis review}. It has been explained that candidate bases, namely the basis
dictionary, shall not be pre-determined. The bases can be chosen adaptively using 
the following iterative approach \cite{adaptive basis 1, adaptive basis 2, adaptive basis 3}. 
In the beginning, some trivial
...
is achieved, without bounding the basis complexity a prior
\cite{adaptive basis 1, adaptive basis 2, adaptive basis 3}. \\

\begin{figure}
    \begin{center}
        \includegraphics[height=8cm]{../algo1_2.png}
